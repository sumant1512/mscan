# Capability: Catalogue - Product Management

## Purpose
Provide comprehensive product catalog management for tenant organizations. Products support SKU tracking, category associations, pricing with multiple currencies, image URLs, descriptions, and active/inactive status. Products can be linked to coupons for targeted promotions and maintain referential integrity with categories.
