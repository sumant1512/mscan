# Capability: Tenant Coupons (Modified for Product Catalogue)

## Purpose
Enable tenant users to create and manage promotional coupons with product associations. This capability was modified to replace text-based product fields with foreign key relationships to the products table for better data integrity and normalization.
